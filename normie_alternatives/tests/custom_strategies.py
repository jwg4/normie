...
inv_erf_floats = floats(min_value=-1.0, max_value=1.0, allow_infinity=False, allow_nan=False)
inv_cdf_floats = floats(min_value=0.0, max_value=1.0, allow_infinity=False, allow_nan=False)
